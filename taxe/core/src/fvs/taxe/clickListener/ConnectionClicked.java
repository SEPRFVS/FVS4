...
public class ConnectionClicked extends ClickListener {
    ...
    public ConnectionClicked(Context context, ConnectionModifier connectionModifier) {
    ...
    public void clicked(InputEvent event, float x, float y) {
        ...
        if (Game.getInstance().getState() == GameState.NORMAL) {
            ...
            DialogResourceConnectionModifier dia = new DialogResourceConnectionModifier(connectionModifier, context.getSkin());
