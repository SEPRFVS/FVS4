...
public class DialogResourceConnectionModifier extends UnifiedDialog {
    private List<ResourceDialogClickListener> clickListeners = new ArrayList<ResourceDialogClickListener>();

    public DialogResourceConnectionModifier(ConnectionModifier connectionModifier, Skin skin) {
